$(document).ready(function () {
    $('#table').DataTable({
            ...
            "columns": [
                ...
                {
                    "data": function () {
                        return "<button class=\"edit btn btn-outline-secondary mr-3 mb-2\" type=\"submit\"\n " +
                            ...
                            + "<button class=\"delete btn btn-outline-success mb-2\" type=\"button\" onclick=\"viewFind(this)\" data-bs-toggle=\"modal\"\n" +
