...
public class Test {
    ...
    public Test(String passport, String name, int id, String surname, String country, String region, String sex, Date doi, Date doe, Date dob, String toDob, String toDoe, String toDoi) {
